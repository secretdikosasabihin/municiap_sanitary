...
<div class="tabs-contents" id="food-tab">
    <div class="card">
        <div class="table-container">
            <table class="data-table">
                ...
                <tbody>
                    @forelse($food as $health)
                        <tr>
                            <td>
                                <input type="checkbox" form="generatePdfForm" name="selected_health_cards[]"
                                    value="{{ $health->id }}" class="selected">
                            </td>
                            ...
                            <td>
                                <button class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#updateModalHealthFood{{ $health->id }}">
                                ...
                                <div class="modal fade" id="updateModalHealthFood{{ $health->id }}" tabindex="-1"
            ...
            <script>
                document.getElementById('selectAlls').addEventListener('click', function (event) {
