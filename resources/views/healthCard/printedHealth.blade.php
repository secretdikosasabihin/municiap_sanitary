...
<div class="tabs-contents" id="printed-tab">
    <div class="card">
        <div class="table-container">
            <table class="data-table">
                <thead>
                    <tr>
                        <th><input type="checkbox" id="selectAllssss"></th>
                        <th>Serial CODE</th>
                        <th>FULL NAME</th>
                        <th>AGE</th>
                        <th>GENDER</th>
            ...
            <script>
                document.getElementById('selectAllssss').addEventListener('click', function (event) {
