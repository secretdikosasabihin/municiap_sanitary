    ...
    <div class="modal fade" id="updateModalHealth{{ $health->id }}" tabindex="-1"
                ...
                <div class="modal-body">
                    <form action="{{ route('healthCard.update', $health->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="health_card_type" name="health_card_type" required>
                                <option value="" disabled>Select Health Card
                                    Type</option>
                                <option value="non_food" @selected($health->health_card_type == 'non_food')>
                                    Non Food</option>
                                <option value="food" @selected($health->health_card_type == 'food')>
                                    Food</option>
                                <option value="others" @selected($health->health_card_type == 'others')>
                                    Others</option>
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="place_of_employment" name="place_of_employment"
