...
<div class="tabs-contents" id="others-tab">
    <div class="card">
        <div class="table-container">
            <table class="data-table">
                <thead>
                    <tr>
                        <th><input type="checkbox" id="selectAllsss"></th>
                        <th>Serial CODE</th>
                        <th>FULL NAME</th>
                        <th>AGE</th>
                        <th>GENDER</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#updateModalHealthOthers{{ $health->id }}">
                                    <i class="fa-solid fa-pen-to-square"></i> &nbsp;Update
                                </button>

                                <!-- Bootstrap Update Modal -->
                                <div class="modal fade" id="updateModalHealthOthers{{ $health->id }}" tabindex="-1"
            ...
            <script>
                document.getElementById('selectAllsss').addEventListener('click', function (event) {
