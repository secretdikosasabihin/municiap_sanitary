...
<div class="tabs-contents" id="notprinted-tab">
    <div class="card">
        <div class="table-container">
            <table class="data-table">
                <thead>
                    <tr>
                        <th><input type="checkbox" id="selectAllsssss"></th>
                        <th>Serial CODE</th>
                        <th>FULL NAME</th>
                        <th>AGE</th>
                        <th>GENDER</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#updateModalHealthPrinted{{ $health->id }}">
                                    <i class="fa-solid fa-pen-to-square"></i> &nbsp;Update
                                </button>

                                <!-- Bootstrap Update Modal -->
                                <div class="modal fade" id="updateModalHealthPrinted{{ $health->id }}" tabindex="-1"
            ...
            <script>
                document.getElementById('selectAllsssss').addEventListener('click', function (event) {
